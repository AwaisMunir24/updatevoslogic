...
import anm from "../../assets/images/layr3.png";
    ...
    <>
      <section className="whatwedo--page">
        <div className="container-xxl">
          <div className="row">
            <div className="col-xxl-5 col-lg-5 col-md-12 col-sm-12">
          ...
          <div className="row automate--section">
            ...
            <div className="col-lg-5 col-md-5">
              <div className="img--section position-relative">
                {/* <img src={anm} alt="" className="img-fluid testing--bg" /> */}
                <img
