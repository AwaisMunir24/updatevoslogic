...
const Home = () => {
  ...
  const parent = { width: `75em`, height: `100%` };
        ...
        <div className="main-wrapper">
            ...
            <div className="container-xxl">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 col-sm-12">
                  <div className="glowing-circle circle  pulse position-relative">
                    <img
                      src={Voslogicimages.shadow}
                      className="img-fluid testing2_bg"
                      alt="shadow"
                    />
                    <img
                ...
                <div className="row configure_sectoion">
                  <div className="col-lg-6 col-md-8">
                    <div className="">
                      ...
                      <div className="waves_animation configuration_waves">
                        <img
                          src={Voslogicimages.animation}
                          alt="sound waves"
          ...
          <section>
            <div className="container-xxl">
              ...
              <div className="row">
                <div className="col-lg-12"> <Reporting /> </div>
              </div>
            </div>
          </section>  */}
          <section className="main_section_of_sections">
            <section className="why_choose_voslogic tabs_section">
              <div className="container-xxl">
                <div className="row choose_voslogic">
                  <div className="col-lg-12">
                    ...
                    <p>
                      ...
                      providers on our back end make us the most reliable
                      solution for your telecommunication needs.
                    </p>
                  </div>
                </div>
              </div>
                            ...
                            <div className="content_section">
                              <TabPanel>
                                <div className="tabs_content_dispcription">
                                  ...
                                  <p>
                                    With access to worldwide routes connecting
                                    your
                                  </p>
                        ...
                        <div style={child} className="child_section">
                          <div className="Caro_main_wrapper  d-flex align-items-center">
                            ...
                            <div className="detail">
                              <h2>Data Driven</h2>
                              <p>
                                We dynamically use outbound call routing to
                                ensure high connectivity rates.
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="here_for_yourself_section">
                    <div className="your_self_inner_section">
                      ...
                      <p className="yourself_discription">
                        ...
                        to interact with. Most people don’t even realize they
                        are speaking to a machine. In fact, you may have already
                        spoken to DISA!
                      </p>
                      <p className="hello_bob">
                        “Hello Bob! How are you doing this afternoon?”
                      </p>
                      <div className="waves_animation">
                        <img
                          src={Voslogicimages.animation}
                          alt="sound waves"
                          className="img-fluid hearing_waves_last_section"
